...
public partial class HelpViewModel : ObservableObject
{
    ...
    [
        ...
        new("Run", "Qualified capture card", "Elgato Game Capture 4K Pro is required for the full supported automated game-benchmark workflow and is the only capture-card model currently qualified by this project. Set Settings > Capture card device to the exact DirectShow name Elgato 4K Pro and confirm it with gpusuite grab --list. Elgato 4K60 Pro, MK.2, generic, or other cards are unqualified for that workflow, although offline authoring, builds, and diagnostic capture commands may still work. The 60 Hz safety setting describes this validated bench path; it is not a general product limit.", "elgato 4k pro capture card qualified 4k60 mk.2 diagnostics 60 hz"),
