...
4. In a separate checkout of `Hardware-Busters/hardware-busters-gpu-test-suite`, create a public candidate branch with one root commit from the exported directory. Open a public pull request; do not copy private history.
